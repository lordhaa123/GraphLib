...
int main()
{
    ...
    auto articulationPoints = grp.articulationPoints();
    ...
    bool isBiconnected = grp.isBiconnected();
    if(isBiconnected) cout<<"it is Biconnected"<<endl;
    else    cout<<"not Biconnected"<<endl;
    cout<<endl;
